...
watch([search, perPage,date], () => {
    router.get(route('delivery.today'), {
        search: search.value,
                        ...
                        <div class="card-title d-flex justify-content-between align-items-center flex-wrap gap-2 mb-0">
                            ...
                            <h6 class="mb-0 text-primary d-flex align-items-center">
                                <a href="javascript:;" class="me-2">
                                    <i class="fadeIn animated bx bx-list-ul"></i> আজকের চালান
                                </a>
                            </h6>
                                ...
                                <table class="table table-striped table-bordered dataTable" style="width: 100%; font-size: small;">
                                    ...
                                    <tbody>
                                        <tr v-for="invoice in invoices.data" :key="invoice.id">
                                            ...
                                            <td>{{ invoice.invoice_details[0]?.rate }}</td>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="#" @click="printThermal(invoice)">
                                                                <i class="bx bx-receipt"></i> থার্মাল প্রিন্ট
                                                            </a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="#" @click="showDeliveryDetails(invoice)">
                                                                <i class="bx bx-truck"></i> ডেলিভারি বিস্তারিত
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="#" @click="showInvoiceDetails(invoice)">
                                                                <i class="bx bx-show"></i> চালান বিস্তারিত
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <li v-for="link in invoices.links"
                                                    ...
                                                    <Link
                                                        ...
                                                        :class="{
                                                            ...
                                                            'text-secondary': !link.active && link.url,
                                                            'text-muted': !link.url
                                                        }"
                                                    />
                                                </li>
                            ...
                            <div class="modal-body" v-if="showModal">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6 col-md-4 mb-3 pe-md-0">
                                        <label class="form-label">চালান তারিখ<span class="text-danger">*</span></label>
                                        <Input type="date" v-model="form.invoice_date" class="form-control form-control-sm" placeholder="চালান নং" :class="[form.errors.invoice_date ? 'border-danger mb-1' : '']" required/>
                                    ...
                                    <div class="col-sm-6 col-md-4 mb-3">
                                        ...
                                        <Input v-model="form.address" class="form-control form-control-sm" placeholder="ঠিকানা" :class="[form.errors.address ? 'border-danger mb-1' : '']" required/>
                                        <InputError :message="form.errors.address" />
                                    </div>

                                    <div class="col-sm-6 col-md-4 mb-3 pe-md-0 pe-sm-0">
                                        <label class="form-label">চালানের ধরণ<span class="text-danger">*</span></label>
                                        <select v-model="form.type" class="form-control form-control-sm" :class="[form.errors.type ? 'border-danger mb-1' : '']">
