...
<template>
    ...
    <AppLayout1>
        <div class="row">
            <div class="col-lg-12">
                <h4 class="mb-3 text-primary text-center font-bold">Supplier</h4>
            </div>
                    ...
                    <div class="card-header">
                        <div class="card-title d-flex justify-content-between justify-center align-items-center" style="margin-bottom: 0;">
                            <h6 class="mb-0 text-primary d-flex align-items-center">
                                <a href="javascript:;" class="me-2"><i class="fadeIn animated bx bx-list-ul"></i> Supplier List</a>
                            </h6>
                            <button class="btn btn-primary btn-sm" @click="createSupplier"><i class="fadeIn animated bx bx-plus-medical" style="font-size: small;"></i>Add Supplier</button>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="border-top: 2px solid #004882;">
                                <h6 class="modal-title"><i class="bx bx-message-alt-add me-2"></i> {{ editingSupplier ?
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm"><i class="fadeIn animated bx bx-plus-medical" style="font-size: small;"></i> {{ editingSupplier ? 'Update' : 'Save' }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
