        ...
        <body>
                ...
                <tbody>
                    ${invoice.invoice_details.map(item => `
                        <tr>
                            ...
                            <td>${Number(item.rate).toFixed(0)}</td>
                            <td>${item.quantity}</td>
            ...
            <div class="totals">
                <div class="totals-row">
                    <span>মোট:</span>
                    <span>${parseFloat(invoice.invoice_details.reduce((total, item) => Number(total) + Number(item.amount), 0)).toFixed(2)}</span>
                </div>
                ...
                <div class="totals-row bold" style="border-top: 1px solid #000; margin-top: 2px; padding-top: 2px;">
                    <span>সর্বমোট:</span>
            ...
            <div class="footer">
                ...
                <p>সফটওয়্যার কারিগরি সহায়তায়: 01700000000</p>
            </div>
