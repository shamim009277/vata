...
// const showUpdateDetails = (production) => {
//     selectedProduction.value = production;
//     showModal.value = true;
//     editProduction.value = true;

//     form.id = production.id;
//     form.invoice_no = production.invoice_no;
//     form.customer_name = production.customer.name;
//     form.phone = production.customer.phone;
//     form.address = production.customer.address;
//     form.type = production.invoice_type;
//     form.delivery_date = production.delivery_date ? production.delivery_date.split('T')[0] : '';
                                            ...
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="#" @click="printChallan(production)">
                                                ...
                                                <tr v-for="(item, index) in form.items" :key="index" style="vertical-align: middle;">
                                                    ...
                                                    <td>
                                                        ...
                                                        >
                                                            ...
                                                            <option v-for="it in fieldsList" :key="it.id" :value="it.id">
                                                                {{ it.name }}
                                                            </option>
                                                        </select>
